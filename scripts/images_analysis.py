...
images_directory = r'images\dir'
resized_directory = r'resized\images\dir'
        ...
        if response != "":
            ...
            match True:
                ...
                case _ if cases == 10:
                    ...
                    if len(lines) > 2:
                        if "child_1" not in extracted_info:
                            extracted_info['child_1'] = {}
                        else:
                            extracted_info['child_1']['name'] = lines[2].replace("Name of dependent: ", "").strip() if len(lines) > 2 else ""
                            extracted_info['child_1']['NIS'] = lines[3].replace("NIS of dependent: ", "").strip() if len(lines) > 3 else ""
                    if len(lines) > 4:
                        if "child_2" not in extracted_info:
                            extracted_info['child_2'] = {}
                        else:
                            extracted_info['child_2']['name'] = lines[4].replace("Name of dependent: ", "").strip() if len(lines) > 4 else ""
                            extracted_info['child_2']['NIS'] = lines[5].replace("NIS of dependent: ", "").strip() if len(lines) > 5 else ""
